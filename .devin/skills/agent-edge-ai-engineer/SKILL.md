...
# agent-edge-ai-engineer

Use this skill when the task would benefit from the edge-ai-engineer agent perspective.

Source of truth: .ai/catalog/agents-source/edge-ai-engineer.md.
