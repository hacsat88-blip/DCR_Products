...
| ドキュメント種別 | 配置先 | 理由 |
|----------------|--------|------|
| トリガー・ゲートの定義 | .ai/assets/books/gates.md | 安定したコア仕様 |
| 実行モード・権限モデル | .ai/assets/books/runtime.md | 全環境共通の動作契約 |
...
- `.ai/core/modules/unified-router.md` remains the detailed router implementation referenced by [routing.md](routing.md).
