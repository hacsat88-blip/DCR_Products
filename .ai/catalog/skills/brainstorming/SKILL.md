...
6. **Write design doc** — save to `docs/dcr/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/dcr/specs/YYYY-MM-DD-<topic>-design.md`
