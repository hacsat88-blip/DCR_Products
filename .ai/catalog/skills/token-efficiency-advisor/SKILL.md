...
description: Use when tasks risk context bloat, excessive tool output, or broad codebase scanning; proactively suggest code-review-graph, context-mode, Serena, or usage monitoring before token-heavy operations across Codex, Claude Code, and Cursor.
contract:
  preconditions:
...
- Cursor: 機能差があるため、まず既存シェル要約と正本優先探索を使う
