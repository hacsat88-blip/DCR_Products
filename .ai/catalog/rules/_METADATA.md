...
- `deploy.ps1` skips `_*.md` files and keeps generated mirrors outside the source-of-truth layer; Cursor `.mdc` and Windsurf rule mirrors are generated from safe defaults
