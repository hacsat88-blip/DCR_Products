...
- Source layer: editable canonical assets (`.ai/catalog/rules/`, `.ai/catalog/skills/`, `templates/`, `.ai/catalog/agents-source/`)
...
- .ai/catalog/rules/*.md + .ai/catalog/skills/*/SKILL.md → ~/.cursor/rules/*.mdc + dcr-kernel.md (Cursor)
- .ai/catalog/agents-source/*.toml → .codex/agents/ (Codex)
- .ai/catalog/agents-source/*.md → .claude/agents/ (Claude Code)
