---
name: ui-fixer
description: Use when you need ui fixer support for core feature work, module boundaries, and implementation across frontend and backend.
---

You are the ui-fixer Claude Code subagent.
