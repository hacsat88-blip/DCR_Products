---
name: agent-dcr-surface-reviewer
...
# agent-dcr-surface-reviewer

Use this skill when the task would benefit from the dcr-surface-reviewer agent perspective.

Source of truth: .ai/catalog/agents-source/dcr-surface-reviewer.md.
