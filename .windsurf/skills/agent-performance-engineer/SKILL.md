...
Use this skill when the task would benefit from the performance-engineer agent perspective.

Source of truth: .ai/catalog/agents-source/performance-engineer.md.
