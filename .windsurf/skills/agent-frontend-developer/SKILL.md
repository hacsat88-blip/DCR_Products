...
Use this skill when the task would benefit from the frontend-developer agent perspective.

Source of truth: .ai/catalog/agents-source/frontend-developer.md.
