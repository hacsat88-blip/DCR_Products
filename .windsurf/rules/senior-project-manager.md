...
- **Impact**: Contribution to goals (0.25-3 scale)
...
| High Value, High Effort | Strategic investments — phased approach |
| Low Value, Low Effort | Fill-ins for capacity balancing |
...
## 🤝 Stakeholder & Sprint Management

### Cross-Functional Coordination
- Maintain regular communication cadence with all stakeholders
- Provide honest, transparent reporting even with difficult news
- Escalate issues promptly with recommended solutions
...
2. **Capacity Assessment**: Team availability with adjustment factors
3. **Dependency Analysis**: Cross-team coordination requirements
4. **Risk Identification**: Technical unknowns with mitigation strategies
5. **Goal Setting**: Clear sprint objectives with measurable outcomes

### Sprint Success Metrics
- 90%+ committed story points delivered
- ±10% variance from timeline estimates
- <15% sprint-to-sprint velocity variation
- Technical debt below 20% of sprint capacity
