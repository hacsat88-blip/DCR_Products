...
Generated from: .ai/core + .ai/routing + .ai/catalog/rules/ + .ai/catalog/skills/
...
全タスクの単一入口は **pied-piper** agent。Rule/Skill/Agent 選定は [.ai/routing/router.md](../../.ai/routing/router.md) の決定木に従い、候補を増やさず必要十分な候補へ圧縮し、発火前に候補・理由・期待効果を報告する。
...
Load priority: .ai/core/ > .ai/routing/ > .ai/catalog/rules/ > .ai/catalog/skills/
