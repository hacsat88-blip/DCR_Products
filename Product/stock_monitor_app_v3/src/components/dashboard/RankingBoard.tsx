...
export const RankingBoard = memo(function RankingBoard({
 ...
 <td className="border-b border-border-subtle/50 px-3 py-2.5">
 <span className="font-mono tabular-nums text-text-primary">{formatYen(stock.price)}</span> / {formatPercent(stock.changePercent)}
 </td>
 <td className="border-b border-border-subtle/50 px-3 py-2.5">
 {stock.coreKpiLabel}: <span className="text-text-primary">{stock.coreKpiValue}</span>
 </td>
 <td className="border-b border-border-subtle/50 px-3 py-2.5 max-w-[200px] truncate">{stock.oneLiner}</td>
