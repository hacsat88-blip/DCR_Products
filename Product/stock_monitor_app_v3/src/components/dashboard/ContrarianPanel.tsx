...
export function ContrarianPanel({ stock }: ContrarianPanelProps): JSX.Element {
 ...
 <div className="mb-3">
 <h2 className="text-lg font-semibold text-text-primary">逆張り監査官</h2>
 ...
 <div
 className="relative overflow-hidden rounded-lg border border-border-subtle bg-canvas-deep/50 p-4 text-sm leading-7 text-text-primary"
 ...
 <span
 className="ml-auto rounded-lg px-2.5 py-0.5 text-[10px] font-bold tracking-wider"
