...
export function SavedScreenPanel({
 ...
 <div className="mb-3">
 <h2 className="text-lg font-semibold text-text-primary">保存スクリーン</h2>
 ...
 className="min-w-[220px] rounded-lg border border-border-subtle bg-canvas/90 px-3 py-2 text-xs text-text-primary outline-none"
 />
 <button
 type="button"
 onClick={() => {
