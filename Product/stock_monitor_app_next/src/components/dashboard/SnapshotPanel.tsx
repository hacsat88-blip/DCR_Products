...
function SnapshotPanelInner({
 ...
 <div>
 <h2 className="text-lg font-semibold text-text-primary">スナップショット履歴</h2>
 ...
 type="button"
 onClick={onSave}
 className="rounded-lg border border-secondary/40 bg-secondary/10 px-3 py-2 text-xs font-semibold text-secondary"
 >
 スナップショット保存
 </button>
 <button
 ...
 <p className="mt-1 text-base font-semibold font-mono tabular-nums">{captures.length}</p>
 </div>
 <div className="rounded-lg border border-border-subtle bg-canvas-deep/60 p-3 text-xs text-text-primary">
 <p className="text-text-muted">最新保存</p>
 <p className="mt-1 font-semibold font-mono tabular-nums">{formatDateTime(latest)}</p>
 </div>
 <label className="rounded-lg border border-border-subtle bg-canvas-deep/60 p-3 text-xs text-text-primary">
 ...
 <div className="mt-3 rounded-lg border border-border-subtle bg-canvas-deep/50 p-3">
 ...
 className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-border-subtle bg-canvas/90 px-3 py-2 text-xs"
 >
 ...
 className="mt-2 w-full rounded-lg border border-border-subtle py-2 text-xs font-semibold text-text-primary transition-colors hover:border-border-active"
 >
