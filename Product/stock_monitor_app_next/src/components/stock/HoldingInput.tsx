...
export function HoldingInput({ stockId, price, changePercent = null, compact = false }: HoldingInputProps): JSX.Element {
  ...
  const evalValue = safePrice !== null && shares > 0 ? shares * safePrice : null;
    ...
    <div onClick={(e) => e.stopPropagation()}>
      ...
      {evalValue !== null && (
        <p className="mt-1 text-xs text-text-muted">
          ...
          {changePercent !== null && (
            <span className={changePercent >= 0 ? "ml-3 text-positive" : "ml-3 text-danger"}>
