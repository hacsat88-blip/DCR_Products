...
**qa-reality-checker**: [final assessment]
...
- **senior-project-manager**: Agile sprint planning, feature prioritization
...
```
Please spawn an agents-orchestrator to execute complete development pipeline for project-specs/[project]-setup.md. Run autonomous workflow: senior-project-manager → ArchitectUX → [Developer ↔ EvidenceQA task-by-task loop] → qa-reality-checker. Each task must pass QA before advancing.
```
